...
module.exports = {
    entry: {
        app:'./src/example4/app.ts',
        page1: './src/example4/page1/page1.ts',
        page2: './src/example4/page2/page2.ts'
    },    
    output: {
        path: path.resolve(process.cwd(), 'src/example4/dist'),
        filename: '[name].js'
    },
    resolve: {
        extensions: ['.ts','.js'],  
    ...
    plugins:[
        ...
        new TsConfigPathsPlugin({configFileName: "./tsconfig.example4.json",compiler: "typescript"}),
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( process.cwd(), 'src/example4/index.html' ),
            filename: 'index.html',
            chunks: ['app'],
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( process.cwd(), 'src/example4/page1/page1.html' ),
            filename: 'page1.html',
            chunks: ['page1'],
            chunksSortMode: 'dependency',
            inject: true
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( process.cwd(), 'src/example4/page2/page2.html' ),
            filename: 'page2.html',
            chunks: ['page2'],
            chunksSortMode: 'dependency',
            inject: true
    ...
    devServer: {
        contentBase: path.join(process.cwd(), "src/example4"),
        openPage: './src/example4/index.html',
        port: 3004
    }
}