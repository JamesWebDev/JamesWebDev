...
module.exports = {
    entry: {
        app:'./example4/app.ts',
        page1: './example4/page1/page1.ts',
        page2: './example4/page2/page2.ts'
    },    
    output: {
        path: path.resolve(__dirname, 'example4/dist'),
        filename: '[name].js'
    },
    resolve: {
        extensions: ['.ts','.js'],  
    ...
    plugins:[
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( __dirname, 'example4/index.html' ),
            filename: 'index.html',
            chunks: ['app'],
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( __dirname, 'example4/page1/page1.html' ),
            filename: 'page1.html',
            chunks: ['page1'],
            chunksSortMode: 'dependency',
            inject: true
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( __dirname, 'example4/page2/page2.html' ),
            filename: 'page2.html',
            chunks: ['page2'],
            chunksSortMode: 'dependency',
            inject: true
    ...
    devServer: {
        contentBase: path.join(__dirname, "example4"),
        openPage: './example4/index.html',
        port: 3004
    }
}