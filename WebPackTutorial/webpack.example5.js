...
module.exports = {
    ...
    output: {
        path: path.resolve(__dirname, 'example5/dist'),
        filename: '[name].js'
    },
    resolve: {
        extensions: ['.ts','.js'],  
    ...
    plugins:[
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( __dirname, 'example5/index.html' ),
            filename: 'index.html',
            chunks: ['app','shared'],
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( __dirname, 'example5/page1/page1.html' ),
            filename: 'page1.html',
            chunks: ['page1','shared'],
            chunksSortMode: 'dependency',
            inject: true
        ...
        new HtmlWebpackPlugin({
            template: path.resolve( __dirname, 'example5/page2/page2.html' ),
            filename: 'page2.html',
            chunks: ['page2','shared'],
            chunksSortMode: 'dependency',
            inject: true
    ...
    devServer: {
        contentBase: path.join(__dirname, "example5"),
        openPage: './example5/index.html',
        port: 3005
    }
}